...
The URL to my "Resume" site is margokellytech.com. There is a link to my resume in the nav bar.
...
I had not used before such as AWS SAM, API Gateway, GitHub Actions, Docker and DynamoDB. This was truly challenging and I 
learned a great deal in the process.
Currently, I am working on completing the TDD, blog and backend CI/CD parts of the challenge.

These are the parts of the challenge that I have completed so far:

1. AWS Certification - AWS Solutions Architect Associate
2. Resume in written using HTML.
